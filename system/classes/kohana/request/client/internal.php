	...
	public function execute_request(Request $request)
	{
		...
		try
		{
                        ...
                        if ($class->hasMethod('action_'.$action))
			{
                        ...
                        /* Jeśli akcja nie istnieje, ale kontroler posiada specjalną metodę przechwytującą */
                        elseif ($class->hasMethod('__call_action'))
                        {
                            $method = $class->getMethod('__call_action'); 
                        }
